...
const Slider = ({slides}) => {
  ...
  return (
    ...
    <div
    className='sm:relative w-full h-full  rounded-2xl bg-center bg-cover duration-500 transform-cpu relative'>
        <div className="h-auto">
        <img className="h-[60%] w-full flex items-center justify-center " src={slides[currentIndex]} alt="" />
